...
exports.migration007CreateSteps = void 0;
exports.migration007CreateSteps = {
    id: '007_create_steps',
    up: (db) => {
        db.exec(`
    ...
    `);
        const sessionColumns = db
            ...
            .all();
        const hasStepSessionCampaign = sessionColumns.some((column) => column.name === 'campaign_id');
...
//# sourceMappingURL=007_create_steps.js.map