...
exports.listPlayerRules = exports.unassignRuleFromPlayer = exports.assignRuleToPlayer = void 0;
const database_1 = require("../database");
const rules_repo_1 = require("./rules-repo");
const assignRuleToPlayer = async (playerId, ruleId) => {
    const db = (0, database_1.getDatabase)();
    // 1. Fetch the rule to check limits
    const rule = await (0, rules_repo_1.getRuleById)(ruleId);
    if (!rule)
...
exports.assignRuleToPlayer = assignRuleToPlayer;
const unassignRuleFromPlayer = async (playerRuleId) => {
    const db = (0, database_1.getDatabase)();
    await db('player_rules').where({ id: playerRuleId }).delete();
};
exports.unassignRuleFromPlayer = unassignRuleFromPlayer;
const listPlayerRules = async (playerId) => {
    const db = (0, database_1.getDatabase)();
    // Fetch associations
    ...
    const rules = await db('rules').whereIn('id', ruleIds);
    // Map them together
...
exports.listPlayerRules = listPlayerRules;
//# sourceMappingURL=player-rules-repo.js.map